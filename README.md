...
## Answer
1.https://github.com/dominja/git-basic.git
2.Add is for staging new or modified files. Commit is for pushing it on your local repo while push is placing it on the remote branch.
